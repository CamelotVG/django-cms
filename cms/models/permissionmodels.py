...
class PageUser(User):
    ...
    """
    page_user_created_by = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="page_created_users")
...
class PageUserGroup(Group):
    ...
    """
    page_user_created_by = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="page_created_usergroups")
